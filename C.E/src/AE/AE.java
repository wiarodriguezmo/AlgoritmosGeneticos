...
public class AE {
    ...
    public static Poblacion evolucionar(Poblacion poblacion, int generaciones){
        boolean fin = false;
        while(!fin){
            Poblacion padres = poblacion.seleccion("torneo",poblacion.individuos.size()); // Existe también: Ranking, Ruleta, Elitista y Elitista.
            ...
            poblacion = poblacion.seleccion("torneo",padres.individuos.size());
